...
CalcAstroBase.svg_sign_symbol = [
    'svg/aries.svg?ver=1.0.1',
    'svg/taurus.svg?ver=1.0.1',
    'svg/gemini.svg?ver=1.0.1',
    'svg/cancer.svg?ver=1.0.1',
    'svg/leo.svg?ver=1.0.1',
    'svg/virgo.svg?ver=1.0.1',
    'svg/libra.svg?ver=1.0.1',
    'svg/scorpio.svg?ver=1.0.1',
    'svg/sagittarius.svg?ver=1.0.1',
    'svg/capricorn.svg?ver=1.0.1',
    'svg/aquarius.svg?ver=1.0.1',
    'svg/pisces.svg?ver=1.0.1',
];
