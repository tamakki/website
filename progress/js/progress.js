...
$(function () {
    ...
    // 保存データを取得
    bodies = localStorage.getItem('bodies_progress');
    bodies2 = localStorage.getItem('bodies2_progress');
    casps = localStorage.getItem('casps_progress');
    magnify = localStorage.getItem('magnify_progress')? parseFloat(localStorage.getItem('magnify_progress')): magnify;
...
function draw() {
    ...
    if(bodies) {
        ...
        let font_size = Math.min( rBodies2 - wPlanets * Math.PI/9, 13 * magnify);
